...
export default function App() {
  ...
  const [history, setHistory] = useState<HistoryItem[]>(() => {
    try {
      ...
      localStorage.removeItem('trichai_history');
      return [];
    }
  });
  ...
  const handleNativeShare = async () => {
    ...
    try {
      ...
      await navigator.share({
        title: lang === 'es' ? 'Mi analisis en TrichAi' : 'My TrichAi Analysis',
        text: lang === 'es' ? 'Mira los resultados de mi analisis en TrichAi.' : 'Check out my analysis results on TrichAi.',
        files: [file],
      });
    } catch (e) {
